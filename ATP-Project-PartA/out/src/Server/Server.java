...
public class Server {
    private int port;//Each Server has alot of Ports
    private int listeningIntervalMS;//Time between each print of "Socket Timeout"
    private IServerStrategy strategy;//solution of the Server
