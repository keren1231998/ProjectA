...
public class Client {
    private final InetAddress serverIP;//IP of the Server
    private final int serverPort;//Port of the server
    private final IClientStrategy strategy;//what the Client send to the Server
